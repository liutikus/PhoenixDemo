...
const Sponsors = () => {
  ...
  return (
    <section className="py-[30px] px-[60px]">
       <div className=" h-full p-[60px] py-[96px] bg-white rounded-2xl shadow-sm relative top-0 left-0 w-ful flex flex-col justify-center items-center text-center">
