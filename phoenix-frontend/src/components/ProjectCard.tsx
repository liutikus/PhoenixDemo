...
const ProjectCard = ({title, bannerImage, active, id}: {title:string, bannerImage:{url:string}, active: boolean, id:string}) => {
  ...
  return (
   <div className=" h-[390px] overflow-hidden bg-white rounded-2xl shadow-md relative top-0 left-0 group">
              ...
              <div className="absolute z-20 p-[2em] bottom-0 left-1/2 transform -translate-x-1/2  w-[100%] ">
